...
my ( $network, $dir, $g2go, $module, $mc, $mp, $hc, $p_value, $global, $help,$term_GO);
my ($bp, $mf, $cc) = (0, 0, 0); 
my ($go, $alpha, $delta);
...
if ($module > 0 || $hc > 0) {
    if (-e $g2go) {
        ...
        my $strin = "perl ".$subposition."/pls/formatgo.pl $g2go $dir/GO $term_GO";
        print "$strin\n";
        #system("perl pls/formatgo.pl $g2go $dir/GO $term_path");
        system($strin);
